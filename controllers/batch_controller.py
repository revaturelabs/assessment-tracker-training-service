...
def route(ans, ins):
    ...
    batch_data = ans.model(
        'Batch Data', {
            "id": fields.Integer(default="0", description='Id generated by the database'),
            "name":
                fields.String(default="Reston-7152021",
                              description='Name of the batch'),
            "trainingTrack":
            ...
            "endDate":
                fields.Integer(default="1639008000",
                               description='Epoch time in seconds'),
            'currentWeek': fields.Integer(default="1",
                                          description='Current week'),
            'totalWeeks': fields.Integer(default="1",
                                         description='Total week of batches')
        })
